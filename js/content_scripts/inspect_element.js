(function() {
  ...
  chrome.storage.sync.get(null, function(items) {
    var workStart      = items.selected_workStart　? items.selected_workStart : "0900";
    var workEnd        = items.selected_workEnd ? items.selected_workEnd : "1800";
    var lunchtimeStart = items.selected_lunchtimeStart ? items.selected_lunchtimeStart : "1200";
    var lunchtimeEnd   = items.selected_lunchtimeEnd ? items.selected_lunchtimeEnd : "1300";
    ...
    $('#recording_timestamp_minute_1').val(workStart.substr(2,2));
    $('#recording_timestamp_hour_2').val(workEnd.substr(0,2));
    $('#recording_timestamp_minute_2').val(workEnd.substr(2,2));
    $('#recording_timestamp_hour_3').val(lunchtimeStart.substr(0,2));
    $('#recording_timestamp_minute_3').val(lunchtimeStart.substr(2,2));
