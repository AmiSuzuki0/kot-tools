...
## これはどんなツール？  
キングオブタイムで勤怠入力をする際に、業務のベースとなる勤怠の時間をワンクリック（もしくはショートカットキー）で入力できるツールです。  
...
- 改善要望があればslackではなくissuesにお願いします。個人でやってるの時間がある時に改修します。
- バグ報告もissuesにお願いします。個人でやってるの時間がある時に改修します。
